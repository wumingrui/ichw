...
>>> def exchange(currency_from, currency_to, amount_from):
    ...
    The function first get data from website according to the input currency，
    then transform it into string format. Using loops to scan the string, we
    can get the number of currency which is ordered to be transformed to."""
